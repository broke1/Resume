    ...
    let obj_settings =  [
        {
            ...
            Kuhni-mytishi.ru — лендинг для компании, предоставляющей услуги,
             связанные с покупкой новой кухни. Примечательно, что тут я выступил в том числе
              в качестве дизайнера, поскольку макет также разрабатывал я. Для создания анимированных эффектов
               в данном проекте использовал jquery. Подключал как сторонние плагины (slick, lightbox), 
               так и многие элементы (выезжающие блоки с разных сторон, мобильное меню) делал сам. 
               Отправка форм осуществляется посредством стандартного Ajax запроса. 
            `
        },
        {
            ...
            таких как lightbox для создания галереи. Форма отправки сделана без помощи плагинов.
             Тут интересно, что экспериментировал с фиксацией заднего фона блоков посредством background-attachment.
              Дизайн разрабатывался совместно с заказчиком, я вносил правки преимущественно при разработке адаптации сайта.
            `
        },
        {
            link: 'Vandeco.ru',
            ...
            Скрипт автоматически определяет местоположение покупателя по ip, а если покупатель не согласен, 
            то благодаря умному поиску (самописному) он может выбрать другой город. Сайт Vandeco.ru разработан на webasyst, 
            и за счет этого реализована целая система статусов заказов. Также настроена интеграция с личным кабинетом 
            службы доставки СДЭК, благодаря самописному скрипту на php.
            `
        },
        {
            link: 'Antivor.ru',
            ...
            фреймворком в частности и с MVC в общем. На странице контактов я работал с API яндекс карт и менял визуальное отображение
             интерфейса карты и маркеров. Сама старница презентации товара написана с использованием Vue.js, 
             а также используя преимущества ES6.  
            `
        },
